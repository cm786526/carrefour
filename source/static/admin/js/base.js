...
$(document).ready(function(){
    ...
    $(".pop-bwin").on("click",function(e){/*关闭模态框*/
        if($(e.target).closest(".pop-content").length==0 && $(e.target).closest(".wrap-address-list").length==0 && $(e.target).closest(".pop-keyboard-content").length==0){
...
function startAudio(key){
    if(navigator.userAgent.indexOf("senguo:androidpfbossapp") >= 0){
